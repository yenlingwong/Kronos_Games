...
<body>
    ...
    <div class="navbar">
        ...
        <?php
            ...
            $sql_query1 = "SELECT * FROM game WHERE name='$title'";
            $result1 = mysqli_query($conn, $sql_query1);
            $sql_query_result1 = mysqli_num_rows($result1);

            if ($sql_query_result1 > 0) {
                while ($row = mysqli_fetch_assoc($result1)) {
                    echo "<h1 style='color:coral;'>Here is the Game Info from our database:</h1>
                    ...
                    <tr style='color:red;font-size:30px;text-align:center;'>
                        <th><p>Name</th></p>
                        <th><p>Platform</th></p>
                        <th><p>Description</th></p>
                        <th><p>Media</th></p>
                    </tr>
                    <tr style='color:limegreen;font-size:30px;text-align:center;'>
                        <td><p>".$row['name']."</td></p>
                        <td><p>".$row['platform']."</td></p>
                        <td><p>".$row['description']."</</td></p>
                        <td><p>".$row['media']."</</td></p>
                    </tr>
                    </table>";
                }
